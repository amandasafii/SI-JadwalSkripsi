    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 flex flex-col items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
                <h2 class="text-center text-xl font-bold">Edit Data Dosen</h2>
                ...
                <form action="/dosen_admin/{{ $data['nidn'] }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label class="block mb-1">Nama Dosen :</label>
                        <input type="text" name='nama_dosen' class="w-full border p-2 rounded"
                            value="{{ isset($data['nama_dosen']) ? $data['nama_dosen'] : old('nama_dosen') }}">
                    </div>
                    <div class="mb-4">
