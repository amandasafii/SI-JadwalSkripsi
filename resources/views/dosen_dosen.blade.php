...
<body class="bg-gray-100 flex h-screen">
    ...
    <!-- Sidebar -->
    <div class="w-64 bg-gray-200 p-5 flex flex-col justify-between h-full">
        <div>
        ...
        <a href="/logout_dosen" class="block py-2 px-4 text-black rounded font-bold  text-center">⬅ Log Out</a>
    </div>

    <!-- Content -->
    <div class="flex-1 p-6">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-semibold">Data Dosen</h1>
            <div class="relative">
                <input type="text" placeholder="Cari nama dosen" class="border p-2 rounded w-64">
