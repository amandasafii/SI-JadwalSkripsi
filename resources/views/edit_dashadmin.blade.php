    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 flex flex-col items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
                <h2 class="text-center text-xl font-bold">Edit Data</h2>
                <h3 class="text-center text-lg font-semibold mb-4">Dashboard Skripsi Online</h3>
                <form action="#" method="POST">
                    <div class="mb-4">
                        <label class="block mb-1">Input sidang hari ini :</label>
                        <input type="text" class="w-full border p-2 rounded">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1">Input jumlah peserta sidang :</label>
                        <input type="text" class="w-full border p-2 rounded">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1">Input jumlah peserta sidang hari ini :</label>
                        <input type="text" class="w-full border p-2 rounded">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-1">Input sisa peserta sidang :</label>
                        <input type="text" class="w-full border p-2 rounded">
                    </div>
