    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 flex flex-col items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
                ...
                <h2 class="text-center text-xl font-bold">Tambah Mahasiswa</h2>
                ...
                @endif
                <form action="{{ url('/mahasiswa_admin') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label class="block mb-1">NPM :</label>
                        <input type="number" name='npm' class="w-full border p-2 rounded"
                            value="{{ isset($data['npm']) ? $data['npm'] : old('npm') }}">
                    </div>
                    <div class="mb-4">
