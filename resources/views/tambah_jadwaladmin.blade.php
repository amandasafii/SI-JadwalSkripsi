...
<head>
    ...
    <title>Tambah Data Jadwal Sidang</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 flex flex-col items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
                <h2 class="text-center text-xl font-bold">Tambah Data Jadwal Sidang</h2>
                ...
                <form action="{{ url('/jadwal_admin') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        ...
                        <select id="kode_ruangan" name="kode_ruangan" class="select2 w-full">
                            ...
                            @foreach ($ruangan as $r)
                                <option value="{{ $r['kode_ruangan'] }}"
                                    {{ old('kode_ruangan') == $r['kode_ruangan'] ? 'selected' : '' }}>
